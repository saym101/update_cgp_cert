...
* **Возможность добавить исключение**: Отключить обновление определённого домена на сервере. Let's Encrypt получать и проверять будет.
...
* **Добавлена работа с кирилическими доменами**: Если добавлен на сервере домен .рф скрипт определяет его и обнавляет.
* **Ротация логов**: По умолчанию 14 дней хранения. Независимо от количества дневных логов. Полезно для тестирования.
